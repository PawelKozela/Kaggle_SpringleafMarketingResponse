...
class FullFeatureSetValidator(BaseFeatureSetValidator):
    """
    Evaluates the feature sets with a short XGBoost: 3500 rounds, 3 seeds
    Takes ~ 4 hours
    """
    ...
    def evaluate_feature_set(self, feature_set_name):
        ...
        result = {
            ...
            'validator': 'FullFeatureValidator',
